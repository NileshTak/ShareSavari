...
import com.ddsio.productionapp.sharesawaari.LogInSignUpQues.LogInSignUpQues
import com.ddsio.productionapp.sharesawaari.R
import com.ddsio.productionapp.sharesawaari.SearchScreen.child.DriverProfile
        ...
        popup.setOnMenuItemClickListener(PopupMenu.OnMenuItemClickListener { item ->
            when (item.itemId) {
                R.id.logout -> {
                    ...
                    activity!!.getSharedPreferences("com.ddsio.productionapp.sharesawaari_preferences", 0).edit().clear().commit()
