package com.ddsio.productionapp.sharesawaari.Intro;
...
//        Fabric.with(this, new Crashlytics());
        ...
        if (restorePrefData()) {
            ...
            SharedPreferences pref = getApplicationContext().getSharedPreferences("com.ddsio.productionapp.sharesawaari_preferences", MODE_PRIVATE);
