...
class LatestMessageRow(val chatMessage: ChatMessage) : Item<ViewHolder>() {
    ...
    override fun bind(viewHolder: ViewHolder, position: Int) {
        ...
        LOGIN_TOKEN = Utils.getStringFromPreferences(
            Configure.LOGIN_KEY,
            "",
            viewHolder.itemView.message_textview_latest_message.context
        )!!
        USER_UPDATE_ID = Utils.getStringFromPreferences(
            Configure.USER_UPDATE_ID,
            "",
            viewHolder.itemView.message_textview_latest_message.context
        )!!
        USER_ID_KEY = Utils.getStringFromPreferences(
