package com.nil.productionapp.sharesavari.InboxScreen
...
import com.nil.productionapp.sharesavari.InboxScreen.Fragments.MessagesFrag
import com.nil.productionapp.sharesavari.InboxScreen.Fragments.NotificationFrag
...
class InboxScreen : Fragment() {
    ...
    override fun onCreateView(
        ...
        adapter.addFragment(NotificationFrag(), "NOTIFICATIONS")
